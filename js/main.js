...
var map;
require(["esri/map", "esri/geometry", "esri/geometry/Point", "esri/geometry/Multipoint", "esri/geometry/Extent", "esri/symbols/SimpleMarkerSymbol", "esri/graphic", "esri/layers/GraphicsLayer", "dojo/domReady!", "esri/dijit/Popup"], function(Map, Geometry, Point, Multipoint, Extent, SimpleMarkerSymbol, Graphic, GraphicsLayer) { 
  map = new Map("mapDiv", {
    basemap: "osm"
  });
  //add points to map, center & zoom
  map.on("load", function(){
    ...
    centerPoint = new Point(latLonArray.getExtent().xmin, latLonArray.getExtent().ymax);
